...
class MlpPolicy(object):
    def __init__(self, sess, ob_space, ac_space, nbatch, nsteps, reuse=tf.AUTO_REUSE, policy_scope='', value_scope=''): #pylint: disable=W0613
        self.pdtype = make_pdtype(ac_space)
        with tf.variable_scope("model"+policy_scope, reuse=tf.AUTO_REUSE):
            ...
            self.pd, self.pi = self.pdtype.pdfromlatent(pi_h2, init_scale=0.01) # pd->probability distribution; pi->policy
